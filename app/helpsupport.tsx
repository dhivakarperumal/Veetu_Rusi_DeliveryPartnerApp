  ...
  const faqs = [
    {
      ...
      a: "Go to the Orders tab, tap on a new order card, and press 'Accept Order'.",
    },
    {
      q: "How do I track my earnings?",
      a: "Visit the Earnings tab to see daily, weekly breakdowns and your payout history.",
    },
    {
      q: "What do I do if I can't find the customer?",
      a: "Use the 'Contact Customer' button on the Track Order screen to call them directly.",
    },
    {
      q: "How long does payout take?",
      a: "Payouts are processed weekly every Monday directly to your registered bank account.",
    },
    {
      q: "How do I update my vehicle details?",
      a: "Go to Profile → Vehicle Information to view your registered vehicle details.",
    },
  ];
  ...
  return (
    ...
    >
      <View className="flex-row justify-between items-center">
        <Text className="text-black font-semibold text-sm flex-1 pr-3">
          {question}
        </Text>
        <Feather
