      ...
      <ScrollView className="flex-1" showsVerticalScrollIndicator={false}>
        <View className="px-6 mt-4 space-y-4">
          ...
          <View className="mt-6 mb-8">
            <Text className="font-bold text-black text-sm mb-4">Order Info</Text>
            
            <View className="flex-row justify-between items-center py-3 border-b border-gray-100">
              <Text className="text-gray-600 text-xs font-medium">Parcel / Document</Text>
              <Text className="text-black text-xs font-semibold">Small Box</Text>
            </View>
            
            <View className="flex-row justify-between items-center py-3 border-b border-gray-100">
              <Text className="text-gray-600 text-xs font-medium">Order Weight</Text>
            ...
            <View className="flex-row justify-between items-center py-4">
              <Text className="text-gray-600 text-xs font-medium">Order Amount</Text>
              <Text className="text-black text-base font-extrabold">₹75.00</Text>
            </View>
          </View>
